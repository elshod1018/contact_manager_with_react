...
export const EditContact = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            setLoading(true);
            try {
                let contactResponse = await ContactService.getContactById(contactId);
    ...
    let handleSubmitForm = async (e) => {
        e.preventDefault();
        try {
            let response = await ContactService.updateContact(contact);
                    ...
                    <div className="row">
                        <div className="col">
                            ...
                            <p className="fst-italic">
                                Lorem ipsum dolor sit amet, consectetur adipisicing elit. Aspernatur consectetur, eum
                                facere hic impedit inventore laudantium pariatur perferendis placeat quasi ratione rem,
                                sapiente, ullam. Commodi eveniet maxime obcaecati quo reiciendis.
                            </p>
                        </div>
                    </div>
                    {
